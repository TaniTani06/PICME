...
while run:
    ...
    if tocar[0] != 0 and x%6 == 0:
        if active_list[3] == 1:
            tocar[0] += 1
    if tocar[0] > 8:                #intervalo mínimo entre dois "toques" consecutivos
                tocar[0] = 0
    ...
    #                    x%6 -> toda quadrinho, uma sequência rápida
    if tocar[1] != 0 and x%6 == 0:
        if active_list[3] == 1:
    ...
    #                    x%12 -> a cada 2 quadrinhos, uma sequência intermediário
    if tocar[2] != 0 and x%12 == 0:
        if active_list[3] == 1:
            pygame.draw.rect(screen, yellow, [0, 240, 218, 80], 0, 5)
            rum.play()
            tocar[2] += 1
    ...
    #                    x%18 -> a cada 3 quadrinhos, uma batida lenta
    if tocar[3] != 0 and x%18 == 0:
        if active_list[3] == 1:
            pygame.draw.rect(screen, yellow, [0, 240, 218, 80], 0, 5)
            rum.play()
            tocar[3] += 1
